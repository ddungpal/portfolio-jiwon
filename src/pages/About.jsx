        ...
        <div className="p-5 pt-0 ">
          {koMode ? (
            <>
              ...
              <div className="flex">
                <div className="w-min mr-2">2017</div>
                <div>서울대학교 미술대학 동양화과 석사졸업 (작품논문: 최지원, ‘즉흥적 드로잉을 통한 순간의 인상표현
                  연구’,서울대학교 대학원)</div>
              </div>
              <div className="flex">
                <div className="w-min mr-2">2015</div>
            ...
            <>
              ...
              <div className="flex">
                <div className="w-min mr-2">2017</div>
                <div>(MA) Asian painting, Seoul National University (Thesis: Jiwon Choi, ‘Investigating the Expression of Moment
                  Impression’,Seoul National University graduate school)</div>
              </div>
              <div className="flex">
                <div className="w-min mr-2">2015</div>
            ...
            {koMode ? (
              <>
                ...
                <p className="p-2 line-clamp text-justify">
                  ...
                  서사방식을 통해 탐구한다. 빠르게 변화하는 환경 속에서 끊임없이
                  대안을 탐색하며 지속 가능성을 연구하고, 이를 작품 안에서
                  움직임의 반복성, 상징성을 띤 매개를 통하여 표현한다. 매년
                  작곡가, 시각예술가, 연주자, 개발자 등 다양한 크리에이터와의
                  협업을 통해 표현하고자 하는 개념의 맥락, 사용하는 도구의 물성,
                  주변을 둘러싼 인적/시공간적 환경의 연대가 맞물릴 때 발현되는
                  파급력을 기대하며 작업하고 있다.
                </p>
              </>
            ) : (
              <>
                ...
                <p className="p-2 line-clamp text-justify">
                  ...
                  converts continuous perspectives such as tradition and analog
                  to explore through media-based narrative methods. It
                  ...
                  properties of the tools used, and the solidarity of the human
                  and temporal environment surrounding us.
                </p>
              </>
            )}
            <hr />
          ...
          {koMode ? (
            <>
              ...
              <div className="flex">
                <div className="w-min mr-2">2022</div>
                <div>
                  ‘0-Phasing-1(0과1의 페이징)’,플랫폼엘 컨템포러리 아트센터,서울
                </div>
              </div>
              <div className="flex">
                <div className="w-min mr-2">2021</div>
          ...
          {koMode ? (
            <>
              ...
              <div className="flex">
                <div className="w-min mr-2">2020</div>
                <div>
                  (과학기술X미디어아트) 다빈치 프로젝트 공모(팀)선정, 주최/주관:
                  한국콘텐츠진흥원
                </div>
              </div>
              <div className="flex">
          ...
          {koMode ? (
            <>
              ...
              <div className="flex">
                <div className="w-min mr-2">2022</div>
                <div>
                  ‘0과 1의 페이징’, 라이브 아츠 퍼포먼스 콜라보, 아하콜렉티브 X
                  아우어퍼쿠션
                </div>
              </div>
              <div className="flex">
