...
export default function WorkSidebar({ selectedContent }) {
  ...
  let contents_2023 = ["21.ppp pppp ppppp.Project", "20.MUNMYO.Project", "19.Up-Down Counter.Project", "0.Yellow Forest.Painting", "1.Swaying Intoversion.Painting", "2.Mirroring Effect.Project", "3.Spanning.Project"];
  let contents_2022 = [
    "4.FLOW.Painting",
    "5.Dialing.Project",
